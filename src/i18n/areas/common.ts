...
const zhCN = {
  ...
  // 外观主题
  'common.theme.label': '外观主题',
  'common.theme.groupAria': '选择外观主题',
  'common.theme.optionAria': '主题：{name}',
  'common.theme.auto': '跟随系统',
  'common.theme.paper': '纸墨',
  'common.theme.ink': '夜墨',
  'common.theme.cinema': '影院',
  'common.theme.wave': '声波',
  'common.theme.autoMood': '浅色用纸墨，深色用夜墨',
  'common.theme.paperMood': '浅色 · 沉静',
  'common.theme.inkMood': '深色 · 静谧',
  'common.theme.cinemaMood': '深色 · 字幕优先',
  'common.theme.waveMood': '浅色 · 明快',
...
const en: Record<keyof typeof zhCN, string> = {
  ...
  'common.theme.groupAria': 'Choose an appearance theme',
  'common.theme.optionAria': 'Theme: {name}',
  'common.theme.auto': 'System',
  'common.theme.paper': 'Paper',
  'common.theme.ink': 'Ink',
  'common.theme.cinema': 'Cinema',
  'common.theme.wave': 'Wave',
  'common.theme.autoMood': 'Paper in light mode, Ink in dark mode',
  'common.theme.paperMood': 'Light · calm',
  'common.theme.inkMood': 'Dark · quiet',
  'common.theme.cinemaMood': 'Dark · subtitles first',
  'common.theme.waveMood': 'Light · vivid',
  ...
  'common.voice.groupTitle': 'Voice-over',
